...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.ad5544_C_AD5544_CS );
      signalAccess[20] = new CDataSignalAccess( top.ad5544_C_AD5544_LDAC );
      signalAccess[21] = new CDataSignalAccess( top.ad5544_C_AD5544_MSB );
      signalAccess[22] = new CDataSignalAccess( top.ad5544_C_AD5544_RS );
      signalAccess[23] = new CDataSignalAccess( top.ad5544_C_AD5544_SCLK );
      signalAccess[24] = new CDataSignalAccess( top.ad5544_C_AD5544_SDIN );
      signalAccess[25] = new CDataSignalAccess( top.biss_c_enc_clk );
      signalAccess[26] = new CDataSignalAccess( top.biss_c_enc_data );
      signalAccess[27] = new CDataSignalAccess( top.ad7606_ad_os );
      signalAccess[28] = new CDataSignalAccess( top.ad7606_ad_cs );
      signalAccess[29] = new CDataSignalAccess( top.ad7606_ad_rd );
      signalAccess[30] = new CDataSignalAccess( top.ad7606_ad_reset );
      signalAccess[31] = new CDataSignalAccess( top.ad7606_ad_convsta );
      signalAccess[32] = new CDataSignalAccess( top.ad7606_ad_convstb );
      signalAccess[33] = new CDataSignalAccess( top.ad7606_ad_range );
      signalAccess[34] = new SDataSignalAccess( top.ad7606_ad_data );
      signalAccess[35] = new CDataSignalAccess( top.ad7606_ad_busy );
      signalAccess[36] = new CDataSignalAccess( top.ad7606_first_data );
      signalAccess[37] = new CDataSignalAccess( top.clk );
      signalAccess[38] = new CDataSignalAccess( top.reset );
      signalAccess[39] = new CDataSignalAccess( top.led );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALAWORK\\EMIF_Test\\.\\simWorkspace\\Phpa_Test/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALAWORK\\EMIF_Test\\.\\simWorkspace\\Phpa_Test/") + name + ".dat").c_str());
      #endif
    }
