...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.top_emif_emif_addr );
      signalAccess[1] = new CDataSignalAccess( top.top_emif_emif_cs );
      signalAccess[2] = new CDataSignalAccess( top.top_emif_emif_we );
      signalAccess[3] = new CDataSignalAccess( top.top_emif_emif_oe );
      signalAccess[4] = new IDataSignalAccess( top.top_emif_emif_data_write );
      signalAccess[5] = new CDataSignalAccess( top.top_emif_emif_data_writeEnable );
      signalAccess[6] = new IDataSignalAccess( top.top_emif_emif_data_read );
      signalAccess[7] = new SDataSignalAccess( top.top_gpioA_write );
      signalAccess[8] = new SDataSignalAccess( top.top_gpioA_writeEnable );
      signalAccess[9] = new SDataSignalAccess( top.top_gpioA_read );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\EMIF_Test\\.\\simWorkspace\\Emif_Ctrl_test/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\EMIF_Test\\.\\simWorkspace\\Emif_Ctrl_test/") + name + ".dat").c_str());
      #endif
    }
