...
object Phpa_TestSim {
  def main(args: Array[String]): Unit = {
    ...
    dut.doSim{dut =>
      ...
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x200, 0x00)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x201, 0x00)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x202, 0x00)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x203, 0x00)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x300, 0xFF)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x301, 0xFF)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x302, 0xFF)
      dut.area.clockDomain.waitSampling(10)
      dut.emif_write(0x303, 0xFF)
      dut.area.clockDomain.waitSampling(10)
