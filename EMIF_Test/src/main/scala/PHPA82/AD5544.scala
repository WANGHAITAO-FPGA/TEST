...
class AD5544(moduleName:String,baseaddr:Long) extends Component {
  ...
  val area = new ClockingArea(ad5544ClockDomain){
    ...
    ctrl.driveAndRead(ad5544_ctrl.io.AD5544_DATA_IN2, 1,bitOffset = 0,documentation = "ad5544---通道2输出数据")
    ctrl.driveAndRead(ad5544_ctrl.io.AD5544_DATA_IN3, 2,bitOffset = 0,documentation = "ad5544---通道3输出数据")
    ctrl.driveAndRead(ad5544_ctrl.io.AD5544_DATA_IN4, 3,bitOffset = 0,documentation = "ad5544---通道4输出数据")
...
class dac_ad5544 extends BlackBox{
  ...
  noIoPrefix()
  addRTLPath("D:/SCALA/EMIF_Test/dac_ad5544.v")
}
