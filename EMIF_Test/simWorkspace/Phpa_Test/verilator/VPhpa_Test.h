...
VL_MODULE(VPhpa_Test) {
  public:
    ...
    struct {
        ...
        SData/*12:0*/ Phpa_Test__DOT__area_counter_valueNext;
        SData/*12:0*/ Phpa_Test__DOT__area_counter_value;
  ...
  public:
    ...
    static void _combo__TOP__28(VPhpa_Test__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _sequent__TOP__27(VPhpa_Test__Syms* __restrict vlSymsp);
    static void _sequent__TOP__29(VPhpa_Test__Syms* __restrict vlSymsp);
