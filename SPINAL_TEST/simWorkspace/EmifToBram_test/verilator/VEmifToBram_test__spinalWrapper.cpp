...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\EmifToBram_test/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\EmifToBram_test/") + name + ".dat").c_str());
      #endif
    }
