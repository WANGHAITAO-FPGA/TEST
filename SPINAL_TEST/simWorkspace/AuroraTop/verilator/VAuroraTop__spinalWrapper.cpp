...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.apb_PADDR );
      signalAccess[1] = new CDataSignalAccess( top.apb_PSEL );
      signalAccess[2] = new CDataSignalAccess( top.apb_PENABLE );
      signalAccess[3] = new CDataSignalAccess( top.apb_PWRITE );
      signalAccess[4] = new IDataSignalAccess( top.apb_PWDATA );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\AuroraTop/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\AuroraTop/") + name + ".dat").c_str());
      #endif
    }
