...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[10] = new CDataSignalAccess( top.apb_PWRITE );
      signalAccess[11] = new IDataSignalAccess( top.apb_PWDATA );
      signalAccess[12] = new CDataSignalAccess( top.apb_PREADY );
      signalAccess[13] = new IDataSignalAccess( top.apb_PRDATA );
      signalAccess[14] = new CDataSignalAccess( top.apb_PSLVERROR );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Emif_Ctrl_test/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Emif_Ctrl_test/") + name + ".dat").c_str());
      #endif
    }
