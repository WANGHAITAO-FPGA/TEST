...
void VAxi_Sim::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("D:/SCALAWORK/TEST/SPINAL_TEST/tmp/job_1/Axi_Sim.v", 18, "",
...
VL_INLINE_OPT void VAxi_Sim::_sequent__TOP__1(VAxi_Sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAxi_Sim::_sequent__TOP__1\n"); );
    VAxi_Sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->__Vdlyvset__Axi_Sim__DOT__area_blockram__DOT__bram__v0 = 0U;
    if (((IData)(vlTOPp->bram_en) & (0xfU == (IData)(vlTOPp->bram_we)))) {
        vlTOPp->__Vdlyvval__Axi_Sim__DOT__area_blockram__DOT__bram__v0 
            = vlTOPp->bram_wrdata;
        vlTOPp->__Vdlyvset__Axi_Sim__DOT__area_blockram__DOT__bram__v0 = 1U;
        vlTOPp->__Vdlyvdim0__Axi_Sim__DOT__area_blockram__DOT__bram__v0 
            = vlTOPp->bram_addr;
    }
    if (((IData)(vlTOPp->bram_en) & (0U == (IData)(vlTOPp->bram_we)))) {
        vlTOPp->Axi_Sim__DOT__area_blockram__DOT___zz_bram_port1 
...
VL_INLINE_OPT void VAxi_Sim::_sequent__TOP__11(VAxi_Sim__Syms* __restrict vlSymsp) {
    ...
    VAxi_Sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->__Vdlyvset__Axi_Sim__DOT__area_blockram__DOT__bram__v0) {
        vlTOPp->Axi_Sim__DOT__area_blockram__DOT__bram[vlTOPp->__Vdlyvdim0__Axi_Sim__DOT__area_blockram__DOT__bram__v0] 
            = vlTOPp->__Vdlyvval__Axi_Sim__DOT__area_blockram__DOT__bram__v0;
    }
}
...
VL_INLINE_OPT void VAxi_Sim::_combo__TOP__13(VAxi_Sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAxi_Sim::_combo__TOP__13\n"); );
    VAxi_Sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->Axi_Sim__DOT__area_axi4top__DOT__axi_readOnly_decoder__DOT__decodedCmdSels 
...
VL_INLINE_OPT void VAxi_Sim::_sequent__TOP__15(VAxi_Sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAxi_Sim::_sequent__TOP__15\n"); );
    VAxi_Sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void VAxi_Sim::_combo__TOP__16(VAxi_Sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAxi_Sim::_combo__TOP__16\n"); );
    VAxi_Sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
