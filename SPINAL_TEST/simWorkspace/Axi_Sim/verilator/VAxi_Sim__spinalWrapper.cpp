...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.axi_ar_valid );
      signalAccess[1] = new CDataSignalAccess( top.axi_ar_ready );
      signalAccess[2] = new IDataSignalAccess( top.axi_ar_payload_addr );
      signalAccess[3] = new CDataSignalAccess( top.axi_ar_payload_id );
      signalAccess[4] = new CDataSignalAccess( top.axi_ar_payload_len );
      signalAccess[5] = new CDataSignalAccess( top.axi_ar_payload_size );
      signalAccess[6] = new CDataSignalAccess( top.axi_ar_payload_burst );
      signalAccess[7] = new CDataSignalAccess( top.axi_aw_valid );
      signalAccess[8] = new CDataSignalAccess( top.axi_aw_ready );
      signalAccess[9] = new IDataSignalAccess( top.axi_aw_payload_addr );
      signalAccess[10] = new CDataSignalAccess( top.axi_aw_payload_id );
      signalAccess[11] = new CDataSignalAccess( top.axi_aw_payload_len );
      signalAccess[12] = new CDataSignalAccess( top.axi_aw_payload_size );
      signalAccess[13] = new CDataSignalAccess( top.axi_aw_payload_burst );
      signalAccess[14] = new CDataSignalAccess( top.axi_w_valid );
      signalAccess[15] = new CDataSignalAccess( top.axi_w_ready );
      signalAccess[16] = new IDataSignalAccess( top.axi_w_payload_data );
      signalAccess[17] = new CDataSignalAccess( top.axi_w_payload_strb );
      signalAccess[18] = new CDataSignalAccess( top.axi_w_payload_last );
      signalAccess[19] = new CDataSignalAccess( top.axi_r_valid );
      signalAccess[20] = new CDataSignalAccess( top.axi_r_ready );
      signalAccess[21] = new IDataSignalAccess( top.axi_r_payload_data );
      signalAccess[22] = new CDataSignalAccess( top.axi_r_payload_id );
      signalAccess[23] = new CDataSignalAccess( top.axi_r_payload_resp );
      signalAccess[24] = new CDataSignalAccess( top.axi_r_payload_last );
      signalAccess[25] = new CDataSignalAccess( top.axi_b_valid );
      ...
      signalAccess[36] = new CDataSignalAccess( top.clkb );
      signalAccess[37] = new CDataSignalAccess( top.resetb );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALAWORK\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Axi_Sim/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALAWORK\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Axi_Sim/") + name + ".dat").c_str());
      #endif
    }
