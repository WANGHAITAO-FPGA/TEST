...
//==========
QData/*63:0*/ VAuroraTxCore::__Vtable1_AuroraTxCore__DOT__auroraTxArea_stateMachine_state_string[8];
...
void VAuroraTxCore::_initial__TOP__1(VAuroraTxCore__Syms* __restrict vlSymsp) {
    ...
    __Vtemp1[2U] = 0x41726561U;
    __Vtemp1[3U] = 0x72615478U;
    __Vtemp1[4U] = 0x6175726fU;
    __Vtemp1[5U] = 0x76656c5fU;
    __Vtemp1[6U] = 0x6f706c65U;
    __Vtemp1[7U] = 0x2e765f74U;
    __Vtemp1[8U] = 0x436f7265U;
    __Vtemp1[9U] = 0x72615478U;
    __Vtemp1[0xaU] = 0x4175726fU;
    VL_READMEM_N(false, 32, 256, 0, VL_CVT_PACK_STR_NW(11, __Vtemp1)
                 , vlTOPp->AuroraTxCore__DOT__auroraTxArea_mem
                 , 0, ~VL_ULL(0));
}

void VAuroraTxCore::_settle__TOP__3(VAuroraTxCore__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAuroraTxCore::_settle__TOP__3\n"); );
    VAuroraTxCore* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
