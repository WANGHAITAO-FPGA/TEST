...
//==========
QData/*63:0*/ VEmifToAurora_test::__Vtable1_EmifToAurora_test__DOT__area_auroratop__DOT__auroraArea_aurorarxcore__DOT__auroraRxArea_stateMachine_state_string[8];
QData/*63:0*/ VEmifToAurora_test::__Vtable2_EmifToAurora_test__DOT__area_auroratop__DOT__auroraArea_auroratxcore__DOT__auroraTxArea_stateMachine_state_string[8];

VL_CTOR_IMP(VEmifToAurora_test) {
    VEmifToAurora_test__Syms* __restrict vlSymsp = __VlSymsp = new VEmifToAurora_test__Syms(this, name());
...
void VEmifToAurora_test::__Vconfigure(VEmifToAurora_test__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

VEmifToAurora_test::~VEmifToAurora_test() {
    delete __VlSymsp; __VlSymsp=NULL;
}

void VEmifToAurora_test::_settle__TOP__2(VEmifToAurora_test__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEmifToAurora_test::_settle__TOP__2\n"); );
    VEmifToAurora_test* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
