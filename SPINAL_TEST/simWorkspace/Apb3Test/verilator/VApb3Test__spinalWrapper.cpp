...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.apb3_PADDR );
      signalAccess[1] = new CDataSignalAccess( top.apb3_PSEL );
      signalAccess[2] = new CDataSignalAccess( top.apb3_PENABLE );
      signalAccess[3] = new CDataSignalAccess( top.apb3_PWRITE );
      signalAccess[4] = new IDataSignalAccess( top.apb3_PWDATA );
      signalAccess[5] = new CDataSignalAccess( top.apb3_PREADY );
      signalAccess[6] = new IDataSignalAccess( top.apb3_PRDATA );
      signalAccess[7] = new CDataSignalAccess( top.apb3_PSLVERROR );
      signalAccess[8] = new IDataSignalAccess( top.gpio_write );
      signalAccess[9] = new IDataSignalAccess( top.gpio_writeEnable );
      signalAccess[10] = new IDataSignalAccess( top.gpio_read );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Apb3Test/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\CODE_LIB\\TEST\\SPINAL_TEST\\.\\simWorkspace\\Apb3Test/") + name + ".dat").c_str());
      #endif
    }
